...
pub const XCURSOR_MAGIC: libc::c_uint = 1920295768;
pub const XCURSOR_IMAGE_TYPE: libc::c_uint = 4294770690;
pub const XCURSOR_IMAGE_VERSION: libc::c_uint = 1;
pub const XCURSOR_IMAGE_MAX_SIZE: libc::c_uint = 32767;
...
pub struct xcb_cursor_context_t {
    ...
    pub root: xcb_window_t,
    pub cursor_font: xcb_font_t,
    pub pf_reply: *mut xcb_render_query_pict_formats_reply_t,
    pub pict_format: *mut xcb_render_pictforminfo_t,
    pub rm: [*mut libc::c_char; 3usize],
    pub size: u32,
    pub home: *const libc::c_char,
    pub path: *const libc::c_char,
    pub render_version: render_version,
}
#[test]
fn bindgen_test_layout_xcb_cursor_context_t() {
    assert_eq!(::std::mem::size_of::<xcb_cursor_context_t>() , 88usize);
    assert_eq!(::std::mem::align_of::<xcb_cursor_context_t>() , 8usize);
}
impl Clone for xcb_cursor_context_t {
    fn clone(&self) -> Self { *self }
}
extern "C" {
    /**
 ...
 */
    pub fn xcb_cursor_context_new(conn: *mut xcb_connection_t,
 ...
 *
 */
    pub fn xcb_cursor_load_cursor(ctx: *mut xcb_cursor_context_t,
                                  name: *const libc::c_char) -> xcb_cursor_t;
}
extern "C" {
    /**
...
pub const RM_XCURSOR_THEME: _bindgen_ty_30 = _bindgen_ty_30::RM_XCURSOR_THEME;
pub const RM_XCURSOR_SIZE: _bindgen_ty_30 = _bindgen_ty_30::RM_XCURSOR_SIZE;
pub const RM_XFT_DPI: _bindgen_ty_30 = _bindgen_ty_30::RM_XFT_DPI;
pub const RM_MAX: _bindgen_ty_30 = _bindgen_ty_30::RM_MAX;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum render_version { RV_NONE = 0, RV_CURSOR = 1, RV_ANIM_CURSOR = 2, }
#[repr(C, packed)]
#[derive(Debug, Copy)]
pub struct xcint_file_header_t {
    pub magic: u32,
    pub header: u32,
    pub version: u32,
    pub ntoc: u32,
...
#[test]
fn bindgen_test_layout_xcint_file_header_t() {
    assert_eq!(::std::mem::size_of::<xcint_file_header_t>() , 16usize);
    assert_eq!(::std::mem::align_of::<xcint_file_header_t>() , 1usize);
}
impl Clone for xcint_file_header_t {
    fn clone(&self) -> Self { *self }
}
#[repr(C, packed)]
#[derive(Debug, Copy)]
pub struct xcint_file_toc_t {
    pub type_: u32,
    pub subtype: u32,
    pub position: u32,
}
#[test]
fn bindgen_test_layout_xcint_file_toc_t() {
    assert_eq!(::std::mem::size_of::<xcint_file_toc_t>() , 12usize);
    assert_eq!(::std::mem::align_of::<xcint_file_toc_t>() , 1usize);
}
impl Clone for xcint_file_toc_t {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
pub struct xcint_cursor_file_t {
    pub header: xcint_file_header_t,
    pub tocs: *mut xcint_file_toc_t,
}
#[test]
fn bindgen_test_layout_xcint_cursor_file_t() {
    assert_eq!(::std::mem::size_of::<xcint_cursor_file_t>() , 24usize);
    assert_eq!(::std::mem::align_of::<xcint_cursor_file_t>() , 8usize);
}
impl Clone for xcint_cursor_file_t {
    fn clone(&self) -> Self { *self }
}
#[repr(C, packed)]
#[derive(Debug, Copy)]
pub struct xcint_chunk_header_t {
    pub header: u32,
    pub type_: u32,
    pub subtype: u32,
    pub version: u32,
...
#[test]
fn bindgen_test_layout_xcint_chunk_header_t() {
    assert_eq!(::std::mem::size_of::<xcint_chunk_header_t>() , 16usize);
    assert_eq!(::std::mem::align_of::<xcint_chunk_header_t>() , 1usize);
}
impl Clone for xcint_chunk_header_t {
    fn clone(&self) -> Self { *self }
}
#[repr(C, packed)]
#[derive(Debug, Copy)]
pub struct xcint_image_t {
    pub width: u32,
    pub height: u32,
    pub xhot: u32,
    pub yhot: u32,
...
#[test]
fn bindgen_test_layout_xcint_image_t() {
    assert_eq!(::std::mem::size_of::<xcint_image_t>() , 28usize);
    assert_eq!(::std::mem::align_of::<xcint_image_t>() , 1usize);
}
impl Clone for xcint_image_t {
    fn clone(&self) -> Self { *self }
}
extern "C" {
    pub fn cursor_shape_to_id(name: *const libc::c_char) -> libc::c_int;
}
extern "C" {
    pub fn parse_cursor_file(c: *mut xcb_cursor_context_t, fd: libc::c_int,
                             images: *mut *mut xcint_image_t,
                             nimg: *mut libc::c_int) -> libc::c_int;
}
